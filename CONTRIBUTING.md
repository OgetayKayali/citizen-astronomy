# Contributing to Citizen Astronomy (CAst)

Thank you for your interest in contributing to CAst.
...
- You cannot fork this project and distribute a modified version. The license does not permit derivative works.
- You are welcome to use, study, and share the software for educational and non-commercial purposes.
- If you want to help improve CAst, I'd be glad to hear from you -- but all changes flow through this repository under my direction.
