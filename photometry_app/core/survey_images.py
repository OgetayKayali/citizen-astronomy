...
SURVEY_DEFINITIONS: tuple[SurveyDefinition, ...] = (
    ...
    SurveyDefinition("dss2_red", "DSS2 Red", "CDS/P/DSS2/red"),
    SurveyDefinition("dss2_ir", "DSS2 IR", "CDS/P/DSS2/NIR"),
    SurveyDefinition("panstarrs", "PanSTARRS", "CDS/P/PanSTARRS/DR1/color-i-r-g"),
    SurveyDefinition("panstarrs_g", "PanSTARRS g", "CDS/P/PanSTARRS/DR1/g"),
    SurveyDefinition("panstarrs_r", "PanSTARRS r", "CDS/P/PanSTARRS/DR1/r"),
    SurveyDefinition("panstarrs_i", "PanSTARRS i", "CDS/P/PanSTARRS/DR1/i"),
    SurveyDefinition("panstarrs_z", "PanSTARRS z", "CDS/P/PanSTARRS/DR1/z"),
    SurveyDefinition("panstarrs_y", "PanSTARRS y", "CDS/P/PanSTARRS/DR1/y"),
    SurveyDefinition("sdss_u", "SDSS u", "CDS/P/SDSS9/u"),
    SurveyDefinition("sdss_g", "SDSS g", "CDS/P/SDSS9/g"),
    SurveyDefinition("sdss_r", "SDSS r", "CDS/P/SDSS9/r"),
    SurveyDefinition("sdss_i", "SDSS i", "CDS/P/SDSS9/i"),
    SurveyDefinition("sdss_z", "SDSS z", "CDS/P/SDSS9/z"),
    SurveyDefinition("twomass_j", "2MASS J", "CDS/P/2MASS/J"),
    SurveyDefinition("twomass_h", "2MASS H", "CDS/P/2MASS/H"),
    SurveyDefinition("twomass_k", "2MASS K", "CDS/P/2MASS/K"),
    SurveyDefinition("wise_w1", "WISE W1", "CDS/P/allWISE/W1"),
    SurveyDefinition("wise_w2", "WISE W2", "CDS/P/allWISE/W2"),
    SurveyDefinition("wise_w3", "WISE W3", "CDS/P/allWISE/W3"),
    SurveyDefinition("wise_w4", "WISE W4", "CDS/P/allWISE/W4"),
    SurveyDefinition("galex_fuv", "GALEX FUV", "CDS/P/GALEXGR6/AIS/FUV"),
    SurveyDefinition("galex_nuv", "GALEX NUV", "CDS/P/GALEXGR6/AIS/NUV"),
    SurveyDefinition("shs_ha", "SHS Ha", "CDS/P/SHS"),
    SurveyDefinition("iphas_dr2_ha", "IPHAS DR2 Ha", "CDS/P/IPHAS/DR2/Ha"),
    SurveyDefinition("nsns_dr0_2_halpha", "NSNS DR0.2 Hα", "simg.de/P/NSNS/DR0_2/halpha"),
    SurveyDefinition("nsns_dr0_2_oiii", "NSNS DR0.2 [OIII]", "simg.de/P/NSNS/DR0_2/oiii"),
    SurveyDefinition("nsns_dr0_2_sii", "NSNS DR0.2 [SII]", "simg.de/P/NSNS/DR0_2/sii"),
)
